...
const AllCharities = [
    {
        ...
        metadata: { "title": "Asset Metadata", "type": "object", "properties": { "Title": { "type": "string", "description": "Feeding America" }, "Description": { "type": "string", "description": "Here goes the DAO description" }, "Start_Date": { "type": "string", "description": "8/17/2024" }, "logo": { "type": "string", "description": { "url": "https://aqua-dull-locust-679.mypinata.cloud/ipfs/bafkreicguxof5vnszbfgotxhgnbulmrjcuifourdvu6r336l5ofejy7az4?pinataGatewayToken=v8BV9VKQs69NLLcVsQaw_fd_pcihpitKGBGpB13WTx40K9pHydzCcywsW0F1yAeL", "type": "image/png" } }, "wallet": { "type": "string", "description": "5EEeMmY9B37Zwio7Q9t9EizBK5bCX9VgKRSA49zZB8zjsuXd" }, "user_id": { "type": "string", "description": "0" }, "SubsPrice": { "type": "number", "description": "5" }, "typeimg": { "type": "string", "description": "Dao" }, "Created_Date": { "type": "string", "description": "8/17/2024" }, "allFiles": [{ "url": "https://aqua-dull-locust-679.mypinata.cloud/ipfs/bafkreicguxof5vnszbfgotxhgnbulmrjcuifourdvu6r336l5ofejy7az4?pinataGatewayToken=v8BV9VKQs69NLLcVsQaw_fd_pcihpitKGBGpB13WTx40K9pHydzCcywsW0F1yAeL", "type": "image/png" }] } }
...
const AllGoals = [
    {
        wallet: "5HBgU6yBy49MT6FC2g8v2YFZnw4FmpQa2ER997gA5M4tJbWX",
        metadata: { "title": "Asset Metadata", "type": "object", "properties": { "Title": { "type": "string", "description": "Community food security in Texas" }, "Description": { "type": "string", "description": "Community food security in Texas\" aims to ensure that every Texan has consistent access to nutritious food, free from the constraints of financial limitations or geographical barriers. This objective involves multifaceted strategies, including addressing food insecurity by implementing programs for food distribution, meal assistance, and nutrition education targeted at vulnerable communities. Beyond mere sustenance, the objective emphasizes the importance of promoting nutritional health, offering diverse and wholesome food options to support the overall well-being of individuals and families." }, "Budget": { "type": "string", "description": "1500" }, "End_Date": { "type": "string", "description": "2024-08-16" }, "user_id": { "type": "string", "description": "0" }, "wallet": { "type": "string", "description": "5HBgU6yBy49MT6FC2g8v2YFZnw4FmpQa2ER997gA5M4tJbWX" }, "logo": { "type": "string", "description": { "url": "https://aqua-dull-locust-679.mypinata.cloud/ipfs/bafkreibutdxyeqqmxcvtg5uvma2sfnwxtl23aigiian3g7wwwzcw3e4hm4?pinataGatewayToken=v8BV9VKQs69NLLcVsQaw_fd_pcihpitKGBGpB13WTx40K9pHydzCcywsW0F1yAeL", "type": "image/jpeg" } }, "allFiles": [{ "url": "https://aqua-dull-locust-679.mypinata.cloud/ipfs/bafkreibutdxyeqqmxcvtg5uvma2sfnwxtl23aigiian3g7wwwzcw3e4hm4?pinataGatewayToken=v8BV9VKQs69NLLcVsQaw_fd_pcihpitKGBGpB13WTx40K9pHydzCcywsW0F1yAeL", "type": "image/jpeg" }] } },
        daoId: 0,
        userId: 0,
...
const AllIdeas = [
    {
        metadata:{ "title": "Asset Metadata", "type": "object", "properties": { "Title": { "type": "string", "description": "Mobile Food Pantries" }, "Description": { "type": "string", "description": "Implementing mobile food pantry programs to bring fresh produce and nutritious food directly to underserved communities, particularly in rural areas or food deserts. Estimated cost: $50,000 per year per mobile unit, including vehicle maintenance, staff salaries, and food procurement." }, "wallet": { "type": "string", "description": "5HBgU6yBy49MT6FC2g8v2YFZnw4FmpQa2ER997gA5M4tJbWX" }, "user_id": { "type": "string", "description": "0" }, "logo": { "type": "string", "description": { "url": "https://aqua-dull-locust-679.mypinata.cloud/ipfs/bafybeihy7cym7fqgpmsqll6ca6fxiizs6c73qvbtn4ej7rkawenuhubd6u?pinataGatewayToken=v8BV9VKQs69NLLcVsQaw_fd_pcihpitKGBGpB13WTx40K9pHydzCcywsW0F1yAeL", "type": "image/jpeg" } }, "allFiles": [ { "url": "https://aqua-dull-locust-679.mypinata.cloud/ipfs/bafybeihy7cym7fqgpmsqll6ca6fxiizs6c73qvbtn4ej7rkawenuhubd6u?pinataGatewayToken=v8BV9VKQs69NLLcVsQaw_fd_pcihpitKGBGpB13WTx40K9pHydzCcywsW0F1yAeL", "type": "image/jpeg" } ] } },
        goalId:0,
        daoId:0,
        userId:0,
